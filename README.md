...
This is a one-page, interactive web application built with Bootstrap 5 to serve as a hub for mental health awareness resources. The site offers users easy access to 4 grid-based cards, each containing informative content on mental health topics.
